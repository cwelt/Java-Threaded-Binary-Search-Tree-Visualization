...
public class GUIApplication extends JFrame implements ActionListener
{
	...
	public GUIApplication(WiredBST<Student> tree) 
	{
		...
		insertIcon = new ImageIcon(getClass().getResource("icons\\insert.png"));
		...
		searchIcon = new ImageIcon(getClass().getResource("icons\\search.png"));
		...
		importIcon = new ImageIcon(getClass().getResource("icons\\import.png"));
